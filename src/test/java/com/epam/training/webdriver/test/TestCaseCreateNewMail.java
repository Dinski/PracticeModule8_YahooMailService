...
public class TestCaseCreateNewMail extends Driver {
    ...
    priority = 2)
    public void composeEmail(String usernameKey, String passwordKey, String to, String sub, String body) {
        try {
            ...
            WebElement composeField = emailPage.openComposeFolder();
            waitForElementToBeClickable(composeField);
            composeField.click();
